...
public class Hex2Dec {
    ...
    public static void main(String[] args) {
      ...
      hex = TextIO.getlnWord();	// returns a non-empty string that does NOT contain blanks
      dec = 0;
      ...
      /*
       * For i, which is 0, iterate up to length of hex
       * 	and make 'digit' = the character at position i
       * 	and IF 'digit' is the same as -1
       * 		print out ERROR
       * 		and RETURN
       * 	make 'dec' = 16 multiplied by 'dec' + 'digit'
       */
