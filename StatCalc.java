 ...
 */
    ...
    public class StatCalc {
        ...
        private double min = Double.POSITIVE_INFINITY;  // Smallest item seen
        	// A constant holding the positive/negative infinity of type double.
        ...
        */
        public void enter(double num) {
          count++;	// iterates the count to include all numbers input
          sum += num;
          squareSum += num*num;	// num multiplied by num = square of num
          // following keeps track of minimum and maximum numbers input by user
          if (num > max)	// if num is GREATER than max
              max = num;		// then max = num
          if (num < min)	// if num is LESS than min
              min = num;		// min = num
        }
        ...
        */
        public double getStandardDeviation() { 
          ...
          // returns the square root of (num*num) / count - (mean*mean)
        }
